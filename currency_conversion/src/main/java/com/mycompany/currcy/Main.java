...
public class Main extends JFrame {
    ...
    private JLabel valueLabel = new JLabel("Enter a value");
    ...
    Main() {
        ...
        frame.setLocation((Toolkit.getDefaultToolkit().getScreenSize().width - 320) / 2, (Toolkit.getDefaultToolkit().getScreenSize().height - 400) / 2);
